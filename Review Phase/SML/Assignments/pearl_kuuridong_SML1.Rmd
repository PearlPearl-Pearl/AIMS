...
test_metrics <- data.frame(
  Metric = c("RMSE", "MAE", "R-squared", "Accuracy"),
  Value  = c(rmse_val, mae_val, r2_val, accuracy)
)
...
On the test set, the AIC-selected model performs quite well. The RMSE of 6.78 shows that predicted house prices typically differ from the actual prices by about 6.8 units, while the MAE of 4.84 indicates that the average error is slightly smaller. With an $R^2$ of 0.70, the model captures roughly $70\%$ of the variation in house prices, which is good enough for this kind of data. Additionally, the accuracy of $52\%$, with a tolerance of 0.1, demonstrates that the model is both reliable and practically useful.
